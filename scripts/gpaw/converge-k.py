...
Ng_set = np.array([2*(i+1) for i in range(50)])
ground_energies = []
fermi_energies = []
N_kpts = []

print('\n========== Convergence Test: g-points =========')
print('===============================================\n')
for i, n in enumerate(Ng_set):
...
plt.xlabel('# of g points')
plt.ylabel('Energy [eV]')
plt.yscale('log')
plt.legend()
plt.savefig(f'{system.outname}_g-convergence.png')
